...
(function (global) {
    ...
    global.App.Model('Employeed', function (setData) {
        /** Creating  the EmployeedModel which will control the Employeed component*/

        this.getEmployeedFullName = function (firstName, lastName) {
            return firstName + ' ' + lastName + ' ' + ' ';
        };

        this.getEmployeedProfession = function (profession) {
            return profession;
        };
...
(function (global) {
    ...
    global.App.Controller('employeed', './components/employeed/', function ($scope, _update) {
        ...
        $scope.inputFocusout = function () {
            ...
            console.log('employeed:inputFocusout', this.name,  this.size, this.bold);
            _update();
        };
